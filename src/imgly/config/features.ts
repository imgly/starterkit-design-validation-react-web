 ...
 *
 * This file configures which features are available in the design validation editor.
...
/**
 * Configure which features are enabled in the design validation editor.
 *
...
export function setupFeatures(cesdk: CreativeEditorSDK): void {
  cesdk.feature.enable([
    ...
    // 'ly.img.fill' /* Fill button and Fill Panel - enables ALL fill types */,
  ...
  // ============================================================================
  // DISABLED FEATURES
  // Features explicitly disabled for the design validation editor
  // ============================================================================

  // #region Disabled Features
  // Disable placeholder and preview features for validation demo
  cesdk.feature.disable('ly.img.placeholder');
  cesdk.feature.disable('ly.img.preview');
}
